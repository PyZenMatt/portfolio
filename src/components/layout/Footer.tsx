...
import { fadeIn, staggerContainer, staggerChild } from '../../motion'
            ...
            {socialLinks.map(({ href, label, Icon }) => (
              ...
              >
                <motion.a
                  ...
                  className="flex items-center gap-2 text-[var(--color-text-secondary)] hover:text-[var(--color-primary)] transition-colors group"
                ...
                >
                  ...
                  <span className="relative">
                    {label}
                    {/* Underline on hover */}
                    <span className="absolute left-0 -bottom-0.5 w-0 h-px bg-[var(--color-primary)] group-hover:w-full transition-all duration-200" />
                  </span>
                </motion.a>
              </MotionDiv>
            ))}
