  ...
  ({ isOpen, className, ...props }, ref) => {
    return (
      <button
        ...
        type="button"
        className={cn(
          'inline-flex items-center justify-center p-2 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-600 transition-colors',
          className
        )}
