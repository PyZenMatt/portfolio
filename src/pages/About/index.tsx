...
export default function About() {
  return (
    <>
      ...
      {/* Header */}
      <div className="mb-12">
        <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-slate-900 dark:text-white mb-6">About Me</h1>
      ...
      <section className="mb-16">
        <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-slate-900 dark:text-white mb-6">Technical Skills</h2>
        <SkillsGrid />
      </section>

      {/* Timeline Section */}
      <section>
        <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-slate-900 dark:text-white mb-6">My Journey</h2>
        <Timeline />
      </section>
    </div>
    </>
