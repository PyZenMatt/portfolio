...
export default function About() {
  return (
    <>
      ...
      {/* Header */}
      <div className="mb-12">
        <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-neutral-900 dark:text-neutral-50 mb-6">About Me</h1>
        
        {/* Bio */}
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <p className="text-base leading-relaxed text-neutral-700 dark:text-neutral-100 mb-4">
      ...
      <section className="mb-16">
        <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-neutral-900 dark:text-neutral-50 mb-6">Technical Skills</h2>
        <SkillsGrid />
      </section>

      {/* Timeline Section */}
      <section>
        <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-neutral-900 dark:text-neutral-50 mb-6">My Journey</h2>
        <Timeline />
      </section>
    </div>
    </>
